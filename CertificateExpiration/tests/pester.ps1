...
Remove-Module CertificateExpiration -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\CertificateExpiration.psd1"
Import-Module "$PSScriptRoot\..\CertificateExpiration.psm1" -Force
