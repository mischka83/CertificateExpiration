<#
	.SYNOPSIS
		Installs the CertificateExpiration Module from github
		
	.DESCRIPTION
		This script installs the CertificateExpiration Module from github.
